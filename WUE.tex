...
\subsubsection{Umströmung in Durchströmung}
		...
		\begin{array}{ll}
			\text{Hohlraumanteil:} & \multirow{2}{0.19\textwidth}{\includegraphics[width=\linewidth]{hohlraumanteil}}\\
			\varepsilon = 1- \dfrac{V_K}{V_0}  \qquad  c = \dfrac{c_0}{\varepsilon}  &\\
			\text{Rohrbündel:} & \multirow{7}{0.4\textwidth}{\includegraphics[width=\linewidth]{rohrbuendel}}\\
...
\subsubsection{Umströmung}
	...
	\begin{array}{llc}
		\text{mit Ablösung:} & \Nuss = 0,56 \displaystyle\sqrt[4]{\Rayl_{krit}\, \cos\alpha} + 0,13 \left( \sqrt[3]{\Rayl} - \sqrt[3]{\Rayl_{krit}} \right) & \multirow{3}{5cm}{\includegraphics[width=\linewidth]{rayleigh-krit}} \\
...
\subsection{Wärmestrahlung zw. Oberflächen}
	...
	\begin{array}{llc}
		\text{Strahlungsbilanz:}                          & a + r + t  =  1                                                                                                                                                                                     & \multirow{3}{6cm}{\includegraphics[width=\linewidth]{strahlung-planck}} \\
...
\begin{figure}[h!b]
	...
	\begin{subfigure}{6cm}
		\centering
		\includegraphics[width=\linewidth]{strahlung-epsilon}
	\end{subfigure}
\end{figure}
